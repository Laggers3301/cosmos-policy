...
from cosmos_policy._src.imaginaire.trainer import ImaginaireTrainer as Trainer
...
from cosmos_policy._src.predict2.configs.common.defaults.dataloader import register_training_and_val_data
...
from cosmos_policy._src.predict2.configs.text2world.defaults.callbacks import register_callbacks
from cosmos_policy._src.predict2.configs.text2world.defaults.conditioner import register_conditioner
from cosmos_policy._src.predict2.configs.text2world.defaults.model import register_model
from cosmos_policy._src.predict2.configs.text2world.defaults.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package("cosmos_policy._src.predict2.configs.text2world.experiment", reload=True)
    return c
